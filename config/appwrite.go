...
func NewAppwriteConfig() *AppwriteConfig {
	return &AppwriteConfig{
		...
		Endpoint:                utils.GetEnv("APPWRITE_ENDPOINT", "https://comics-galore.co/v1"),
		...
		RecoveryURL:             utils.GetEnv("APPWRITE_RECOVERY_URL", "https://comics-galore.co/v1/authentication/recovery"),
		...
		EmailVerificationURL:    utils.GetEnv("APPWRITE_EMAIL_VERIFICATION_URL", "https://comics-galore.co/v1/authentication/verification"),
